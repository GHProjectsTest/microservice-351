...
public class mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "351", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-351/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getDishRatings(@PathParam("id") String id) {
    ...
    if(dish_not_found_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_NOT_FOUND).entity(.toJSONString()).build();
    }
    // ratings
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "created_rating"),
  ...
  public Response postDishRating(String body, @PathParam("id") String id) {
   ...
   try { 
    ...
    if(created_rating_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity(created_rating.toJSONString()).build();
    }
    // bad_request
